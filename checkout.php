    ...
    <div class="all-content">
        ...
        <nav class="navbar navbar-expand-md" id="navbar">
            ...
            <div class="icons">
                ...
                <img class="nav-link-active"src="./image/add.png" alt="" width="24px">
            </div>
          </nav>
        <!-- navbar end -->
      ...
      <!-- cart -->
            <section class="container" id="head"    data-aos="fade-up"
                ...
                <<div class="checkoutLayout">
                    <div class="returnCart">
                        ...
                        <div class="item">
                            ...
                            <div class="info">
                                <div class="name">Bueno Brownie</div>
                                <div class="price">AED 22 </div>
                            </div>
                                <div class="quantity">5</div>
                                <div class="returnPrice">AED 110</div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="right">
                        ...
                        <div class="return">
                            ...
                            <div class="row">
                                <div>Total Price</div>
                                <div class="totalPrice">AED 100</div>
                            </div>
                        </div>
                        <button class="buttonCheckout">ORDER</button>
                        </div>
                    </div>
                </div>
